...
post_list = [
  ...
  ["Jardim", "a pop-up bar, build out of black containers with a view on the Schelde", "permanent", "Scheldekaai, 28", "Antwerp", "Belgium", "v1530605708/Jardim.jpg", "", "", "Nightlife", [Tag.find_by(name: "stays forever")]],
  ...
  ["Havenhuis", "Build on top of the 100-year old fire station entirely made of unequel windows. It looks like a huge rough Diamond.", "permanent", "Zaha Hadidplein, 1", "Antwerp", "Belgium", "v1530605708/Havenhuis.jpg", "","", "Culture", [Tag.find_by(name: "starchitects")]],
  ["Hendrik Conscience Heritage Library", "Whit a bit of luck the doors are opened in the weekend and you get the chance to have a glance at the more than 600 year-old library.", "permanent", "Hendrik Conscienceplein, 4", "Antwerp", "Belgium", "v1530605708/Hendrik_Conscience_Heritage_Library.jpg", "", "", "Culture", [Tag.find_by(name: "love-books")]],
  ...
  ["Johnny Velvet", "Clothing store for men and women where upcoming brands are tried out to see the respond of the market, on the verge of trendy brands and unknown brands.", "permanent", "Rue de l'Hôpital, 1", "Brussels", "Belgium", "v1530605707/Johnny_velvet.jpg", "", "", "Shop", [Tag.find_by(name: "crafty")]],
  ["Caroline record shop", "Expert record shop for vinyls, where you can find everything from second hands records to the latest album released in almost every genre of music.", "permanent", "Boulevard Anspach, 101", "Brussels", "Belgium", "v1530605707/Caroline_record_shop.jpg", "", "", "Shop", [Tag.find_by(name: "music")]],
  ["Le Perroquet", "Spacious corner bar & restaurant with art nouveau-style interior, stained glass & outdoor seating.", "permanent", "Rue Watteeu, 31", "Brussels", "Belgium", "v1530605707/Le_perroquet.jpg", "", "", "Eat & drink", [Tag.find_by(name: "food")]],
  ["Jam Hotel Rooftop", "Rooftop bar where some summer sales are conducted once a month for local producers of clothing and accessories.", "permanent", "Chaussée de Charleroi, 132", "Brussels", "Belgium", "v1530605706/jam_hotel.jpg", "", "", "Nightlife", [Tag.find_by(name: "mind-blowing"), Tag.find_by(name: "with-a-view")]],
  ["PLAY-LABEL Rooftop bar", "The rooftop bar is located between two of the most beautiful areas in Brussels, The Sablon and the Marolles, where you can find sets from independent artists playing in B2B.", "temporary", "Boulevard de l’Empereur, 36", "Brussels", "Belgium", "v1530605706/PLAY_LABEL_ROOFTOP_BAR.jpg", "May, 2018", "September, 2018", "Nightlife", [Tag.find_by(name: "with-a-view"), Tag.find_by(name: "music")]],
  ["Casa Mundial", "beautiful place in Brussels to enjoy the world cup with your friends and colleagues. An elegant 19th-century mansion in the Botanique neighbourhood, with a mix a football game and electro set.", "temporary", "Rue Royale, 290", "Brussels", "Belgium", "v1530696516/casa-mundial-futbol-et-electro.jpg", "June, 2018", "July, 2018", "sports", [Tag.find_by(name: "drinks")]],
  ["Victor Boin Swimming pool", "Amazing swimming pool newly renovated in a Art-deco style.", "permanent", "Rue de la Perche, 38", "Brussels", "Belgium", "v1530696516/victor_boin_.jpg", "", "", "sports", [Tag.find_by(name: "starchitects")] ],
  ["Brasserie verschuren", "Art deco establishment with a great atmosphere located in Parvis Saint Gilles wwith an offer of local beers from micro-breweries.", "permanent", "Sint-Gillisvoorplein 11", "Brussels", "Belgium", "v1530696516/brasserie_Verschueren.jpg", "", "", "drinks", [Tag.find_by(name: "monk beers")]],
  ["Duden Park", "Plantations of beech trees cover the steep small valleys and share the 23 hectares of Duden Park with dense underbrush containing maple and ash, with luzula and ferns at their feet", "permanent", "Duden Park", "Brussels", "Belgium", "v1530696523/duden_parl.jpg", "", "", "hobby", [Tag.find_by(name: "sunday-chilling")]]
]
